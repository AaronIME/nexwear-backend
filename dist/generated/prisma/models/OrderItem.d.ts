...
export type OrderItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "orderId" | "productId" | "productVariantId" | "imageUrl" | "colorName" | "sizeName" | "productName" | "quantity" | "price", ExtArgs["result"]["orderItem"]>;
